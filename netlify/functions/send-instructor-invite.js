// netlify/functions/send-instructor-invite.js
...
<tr><td style="padding:36px 40px 24px;">
  ...
  <div style="color:#64748b;font-size:13px;">Visit <a href="${APP_URL}" style="color:#1a7a3c;">${APP_URL}</a> and log in with your email and the default password <strong>pass</strong>.</div></td></tr></table>
  ...
  <div style="color:#64748b;font-size:13px;">You will be asked to change your password on first login. Choose something secure.</div></td></tr></table>
  ...
  <td valign="top" style="padding-left:12px;"><div style="font-weight:bold;color:#0a2e14;font-size:14px;margin-bottom:2px;">Complete Your Profile & Access Dashboard</div>
  <div style="color:#64748b;font-size:13px;">Complete your profile, then access your instructor dashboard to view your assigned trainees and submit monthly performance reviews.</div></td></tr></table>
  ...
  try {
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        html: buildHTML({ full_name, email }),
      }),
    })
