...
import { Users, UserCheck, BookOpen, GraduationCap, ArrowRight, Clock } from 'lucide-react'
      ...
      <div className="stats-grid">
        {[
          ...
          <div className="stat-card" key={item.label}>
            <div className={`stat-icon ${item.variant}`}>
              <item.icon size={20} />
            </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12, marginBottom: 28 }}>
        {[
          ...
          <button
            ...
            style={{
              background: action.color, color: 'white', border: 'none', borderRadius: 12,
